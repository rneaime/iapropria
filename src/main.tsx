...
document.documentElement.style.setProperty('--primary-foreground', '0 0% 98%'); // light gray text for contrast
...
document.documentElement.style.setProperty('--sidebar-primary-foreground', '0 0% 98%'); // light gray text
